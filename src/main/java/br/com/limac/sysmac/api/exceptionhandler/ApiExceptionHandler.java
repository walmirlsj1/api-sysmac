package br.com.limac.sysmac.api.exceptionhandler;

import br.com.limac.sysmac.domain.exception.EntidadeEmUsoException;
import br.com.limac.sysmac.domain.exception.EntidadeNaoEncontradaException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex,
        ...
        String detail = String.format("A propriedade '%s' não existe. "
                + "Altere ou remova essa propriedade e tente novamente.", path);
    ...
    public ResponseEntity<?> handleTokenInvalidException(JwtException ex, WebRequest request) {
    ...
    public ResponseEntity<?> handleBadCredentialsException(BadCredentialsException badCredentialsException, WebRequest request) {
//        HttpStatus status = HttpStatus.OK;
//        ProblemType problemType = ProblemType.DADOS_INVALIDOS;
//        String detail = badCredentialsException.getMessage();
//        Problem problem = createProblemBuilder(status, problemType, detail)
//                .userMessage(detail)
//                .build();
//
//        return handleExceptionInternal(badCredentialsException, problem, new HttpHeaders(), status, request);
